...
public class ModFoods {
    ...
    public static final FoodProperties TIRAMISU = (new FoodProperties.Builder()).nutrition(9).saturationMod(0.3F).effect(new MobEffectInstance(ModEffects.CAFFEINE.get(), 600, 1), 1.0F).build();
}
